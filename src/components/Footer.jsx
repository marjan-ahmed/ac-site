...
const Footer = () => {
  return (
<footer className="bg-gradient-to-tr from-[#387e9c] to-[#46A3B2] text-gray-50">
    ...
    <div className="grid gap-8 md:grid-cols-3">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm sm:text-md">
          ...
          <li><a href="tel:+923333474568" className="hover:text-white">+92 3333474568</a></li>
        </ul>
      </div>
    </div>

    {/* Divider */}
    <div className="mt-10 border-t border-gray-100 pt-6 text-sm text-center text-gray-50">
